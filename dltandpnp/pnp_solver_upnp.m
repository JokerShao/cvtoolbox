...
% https://blog.csdn.net/App_12062011/article/details/82216069    UPnP
...
function [Rcw, tcw] = pnp_solver_epnp(Pts, pts, cx, cy)
...
M = zeros(2 * n, 12);
for i = 1:n
    M(2 * i - 1, :) = [alpha(1, i), 0, alpha(1, i) * (cx - pts(1, i)) ...
                       alpha(2, i), 0, alpha(2, i) * (cx - pts(1, i)) ...
                       alpha(3, i), 0, alpha(3, i) * (cx - pts(1, i)) ...
                       alpha(4, i), 0, alpha(4, i) * (cx - pts(1, i))];
    M(2 * i, :) = [0, alpha(1, i), alpha(1, i) * (cy - pts(2, i)) ...
                   0, alpha(2, i), alpha(2, i) * (cy - pts(2, i)) ...
                   0, alpha(3, i), alpha(3, i) * (cy - pts(2, i)) ...
                   0, alpha(4, i), alpha(4, i) * (cy - pts(2, i))];
end
...
% betas10 = [b11 b12 b22 b13 b23 b33 b14 b24 b34 b44] bij = bi*bj
